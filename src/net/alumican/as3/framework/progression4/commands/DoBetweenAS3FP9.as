package net.alumican.as3.framework.progression4.commands
{
	 ...
	 */
	public class DoBetweenAS3FP9 extends Command
	{
		/**
		 * 実行Tween
		 */
		 ...
		 * コンストラクタ
		 */
		public function DoBetweenAS3FP9(tween:ITween, useTransition:Boolean = true, initObject:Object = null):void
		{
		...
		{
			return new DoBetweenAS3FP9(_tween.clone(), _useTransition, this);
		}
