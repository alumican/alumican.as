package net.alumican.component.imageslice
{
	 ...
	 */
	public class ImageSlice extends LivePreviewParent
	{
		//----------------------------------------
		//CLASS CONSTANTS
		...
		public function set filename(value:String):void { _filenameField.text = _filename = value; }
		 ...
		 * コンストラクタ
		 */
		public function ImageSlice():void
		{
			trace("construct");
			super();
			...
			//ハンドカーソル
			_area.addEventListener(MouseEvent.MOUSE_OVER, _areaMouseOverHandler);
			buttonMode = true;
		}
		
		private function _areaMouseOverHandler(e:MouseEvent):void 
		{
		}
